...
export default function Sidebar(props: any) {
    ...
    const highlightButton = (ui: number) => {
        if (props.ui() === ui)
            return "bg-accent"
        else
            return ""
    ...
    return (
        ...
        <aside class="w-20 flex flex-col justify-between h-screen border-r bg-background">
                ...
                <nav class="flex flex-col items-center gap-8 px-2 sm:py-5">
                    ...
                    <Tooltip>
                        <TooltipTrigger>
                            <a
                                onClick={() => { changeUi(1) }}
                                class={highlightButton(1) + " flex h-9 w-9 items-center justify-center rounded-lg text-muted-foreground transition-colors hover:text-foreground md:h-10 md:w-10"}
                            >
                    ...
                    <Tooltip>
                        <TooltipTrigger>
                            <a
                                onClick={() => { changeUi(2) }}
                                class={ highlightButton(2) + " flex h-9 w-9 items-center justify-center rounded-lg text-accent-foreground transition-colors hover:text-foreground md:h-10 md:w-10" }
                            >
                    ...
                    <Tooltip>
                        <TooltipTrigger>
                            <a
                                onClick={() => { changeUi(3) }}
                                class={ highlightButton(3) + " flex h-9 w-9 items-center justify-center rounded-lg text-muted-foreground transition-colors hover:text-foreground md:h-10 md:w-10"}
                            >
                    ...
                    <Tooltip>
                        <TooltipTrigger>
                            <a
                                onClick={() => { changeUi(4) }}
                                class={ highlightButton(4) + " flex h-9 w-9 items-center justify-center rounded-lg text-muted-foreground transition-colors hover:text-foreground md:h-10 md:w-10"}
                            >
                    ...
                    <Tooltip>
                        <TooltipTrigger>
                            <a
                                onClick={() => { changeUi(5) }}
                                class={ highlightButton(5) + " flex h-9 w-9 items-center justify-center rounded-lg text-muted-foreground transition-colors hover:text-foreground md:h-10 md:w-10" }
                            >
                ...
                <nav class="mt-auto flex flex-col items-center gap-4 px-2 sm:py-5">
                    <Tooltip>
                        <TooltipTrigger>
                            <a
                                onClick={() => { changeUi(6) }}
                                    class={ highlightButton(6) + "flex h-9 w-9 items-center justify-center rounded-lg text-muted-foreground transition-colors hover:text-foreground md:h-10 md:w-10"}
                            >
