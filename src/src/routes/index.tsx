...
export default function Index() {
    ...
    const groups = [
        { id: 1, name: "WOG INTERNATIONAL", description: "silly geese bleh bleh bleh bleh" },
        { id: 2, name: "Techies United", description: "Coding and Tech Talk" },
        { id: 3, name: "Gaming Hub", description: "All about games!" },
    ];
